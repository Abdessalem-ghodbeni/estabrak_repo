...
import com.biat.biat.Repository.ICaissierRepository;
...
private final ICaissierRepository caissierRepository;
    @Override
    ...
    public AuthenticationResponse login(String email, String password) {
        ...
        } else if (user.getRole()==Role.CAISSIER) {
            Caissier client = (Caissier) user;
            Caissier agentDto = convertToClientDto(client);
            authenticationResponse.setUserDetails(agentDto);
        } else {
    ...
    @Override
    public Caissier addClient(Caissier client) {
        client.setPassword(passwordEncoder.encode(client.getPassword()));
        return caissierRepository.save(client);
    }
    ...
    private Caissier convertToClientDto(Caissier client) {
        Caissier dto = new Caissier();
